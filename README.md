# 价值投资分析终端 V2.5 — Professional Financial Terminal
...
| 模块 | 功能 | 状态 |
|------|------|------|
| 📊 **ROI 价值仪表盘** | 4 列资产卡片 + **投资回报率 (ROI)** 排行榜 | ✅ |
| 💰 **实时行情引擎** | 基于腾讯财经 API，10 秒自动刷新，批量拉取 | ✅ |
| 📉 **智能股息探测** | 基于东方财富去重，动态探测分红频率（年/中报），测算最真实的滚动回报！ | ✅ |
| 📈 **价差对冲终端** | 分时/日线价差分析，ROI 矩阵横向对比，客户端缓存 | ✅ |
...
```
## 页面展示
![项目截图](QQ图片20260327161155.png)
![项目截图](QQ图片20260327161212.png)
![项目截图](QQ图片20260327161107.png)
## 环境要求
...
| V2.5 | **价值评价体系升级**：更名为价值投资分析终端，引入智能分红周期推算（解决财报跨期/重叠），新增 $ROI=ROE/PB$ 评价指标及洋河股份 $20\% ROE$ 保底算法。 |
