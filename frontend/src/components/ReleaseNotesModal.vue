...
const updates = [
  {
    title: '🧰 工具箱：7 个可拖拽投资工具',
    text: '组合仓位+分红（百分比/股数双模式）、复利计算器、安全边际、仓位管理、分红日历、集中度热力图、换股计算器。支持拖拽、缩放、位置记忆。',
  },
  {
    title: '📊 ROI 柱状图双色拆分',
    text: '投资回报率拆分为资本回报（青色）和分红回报（粉色），右侧显示合计值，一目了然看出收益来源。',
  },
  {
    title: '📅 分红日历智能估算',
    text: '支持一年多次分红的公司（如东阿阿胶），按去年分红次序预估，已发过的自动跳过，不再硬编码 365 天。',
  },
  {
    title: '🔌 新增 Baostock + Tushare 数据源',
    text: 'Baostock 免费无限制作为历史 K 线兜底；Tushare Pro 免费接口覆盖三大财务报表和融资融券。AkShare 失败时自动切换。',
  },
]
