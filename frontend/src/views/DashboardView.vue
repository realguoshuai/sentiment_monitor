    ...
    <header class="flex justify-between items-center mb-3 shrink-0">
      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <router-link to="/news-report" class="flex items-center gap-1.5 px-3 py-1.5 bg-[#1e293b] hover:bg-slate-700 text-slate-300 rounded border border-slate-700 transition-colors text-[11px]">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10l4 4v10a2 2 0 01-2 2zM17 8h-4v4h4V8zm-8 0H7v1h2V8zm0 3H7v1h2v-1zm0 3H7v1h2v-1zm4-3h-1v1h1v-1zm0 3h-1v1h1v-1z"/></svg>
            资讯报告
          </router-link>
          <WidgetDock />
